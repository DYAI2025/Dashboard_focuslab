  ...
  return (
    ...
    >
      ...
      <div className="relative flex items-center justify-center w-2 h-2 shrink-0">
        {/* Base Light Body */}
        <div className={`absolute w-full h-full rounded-full ${accentColor} transition-all duration-300 ${
          active 
            ? 'animate-pulse scale-125 shadow-[0_0_8px_rgba(34,211,238,0.8)]' 
            : 'opacity-40 group-hover:opacity-100 group-hover:shadow-[0_0_6px_rgba(34,211,238,0.4)]'
        }`} />
