  ...
  return (
    <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden opacity-25 select-none">
      ...
      <div className="absolute bottom-10 left-10 text-[8px] font-mono text-slate-500 space-y-1">
        <div className="flex gap-2"><span className="text-cyan-500 font-bold">STATUS::</span> TRANSMITTING</div>
        <div className="flex gap-2"><span className="text-cyan-500 font-bold">SOURCE::</span> HABITAT_04_G</div>
        <div className="flex gap-2"><span className="text-cyan-500 font-bold">COORD::</span> 14.281 / -0.0932</div>
      </div>
      ...
      <div className="absolute top-24 left-1/2 -translate-x-1/2 flex items-center gap-12 text-[7px] font-mono text-slate-500 tracking-[0.5em] uppercase">
        ...
        <span className="text-cyan-500">SYNC_ACTIVE</span>
        <div className="w-20 h-px bg-slate-800" />
        <span>V_0.9.4.1</span>
      </div>
    </div>
